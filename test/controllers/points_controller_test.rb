...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { altitude: @point.altitude, direction: @point.direction, lat: @point.lat, long: @point.long, speed: @point.speed, user_id: @point.user_id } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { altitude: @point.altitude, direction: @point.direction, lat: @point.lat, long: @point.long, speed: @point.speed, user_id: @point.user_id } }
